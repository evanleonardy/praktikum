...
<html lang="en">
 ...
 @include('includes.navbar')
      ...
      <div class="jumbotron jumbotron-fluid">
        <div class="container">
          <h1 class="display-4" style="color:lightcoral">Biodata Siswa</h1>
      ...
      <div class="container">
        <div class="row">
          <div class="col-md-2">
            <img src="{{ url('images/maya.jpg') }}" class="rounded-circle" width="80% ">
          </div>
          <div class="col-md-6">
            Informasi Pribadi
            <div class="card">
                <div class="card-header">
                  <h5 class="card-title" style="color:lightseagreen">Informasi Ku</h5>
                </div>
                <div class="card-body">
                  <div class="row">
        ...
        <div class="text-center mt-5 mb-5" style="color:lightseagreen"><h4>Pencapaian dan Pengalaman</h4></div>
      <div class="row">
        <div class="col-md-6">
          <div class="card">
